...
import cn.hamm.wecom.module.common.access.token.AccessTokenApi;
import cn.hamm.wecom.module.common.ip.ApiDomainIpApi;
...
//        getAccessToken();
        ...
        try {
            List<String> ipList = new ApiDomainIpApi().setAccessToken(accessToken).request().getIpList();
